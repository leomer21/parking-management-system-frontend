    ...
    <div className="p-2 bg-white rounded-lg w-full">
      ...
      <div className="flex max-md:flex-col justify-between items-center">
        <div className="flex p-2 gap-2">
          <Button onClick={() => setFilter("super")} color="green">
            Super admin
          </Button>
          <Button onClick={() => setFilter("end")} color="rose">
            End Users
          </Button>
          <Button onClick={() => setFilter("all")} color="blue">
            All
          </Button>
        </div>
            ...
            body={(user: UserType) => (
              <div className="flex justify-between gap-1">
                ...
                <div className="flex gap-1">
                  ...
                  {user.emailVerified && (
                    <span className="p-1 bg-yellow-600 text-white rounded-md text-xs">
                      verified
                    </span>
                  )}
                </div>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell align="center">
                    <img
                      className="rounded-full w-10 h-10 min-w-10 min-h-10 mx-auto"
                      src={
                        user?.photoURL ||
                        `${import.meta.env.VITE_API_PUBLIC_URL}/user.png`
                      }
                ...
                <TableRow>
                  ...
                  <TableCell align="center">
                    <div className="flex items-center">
                      ...
                      <button
                        onClick={async () => {
                          await axios.post("/user/set-admin", {
                            uid: user?.uid,
                            value: user?.customClaims?.admin ? false : true,
                          });
                          fetchData();
                          setVisible(false);
                        }}
                ...
                <TableRow>
                  ...
                  <TableCell align="center">
                    {user?.emailVerified ? (
                      ...
                      <span className="p-1 bg-red-600 text-white rounded-md text-xs">
                        Not Verified
                      </span>
                    )}
                  </TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell align="center">
                    {user?.disabled ? (
                      ...
                      <span className="p-1 bg-cyan-600 text-white rounded-md text-xs">
                        No
                      </span>
                    )}
                  </TableCell>
